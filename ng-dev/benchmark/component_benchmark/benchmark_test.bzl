...
def benchmark_test(name, server, tags = [], **kwargs):
    protractor_web_test_suite(
        name = name,
        browsers = ["//ng-dev/browsers/chromium:chromium"],
        configuration = "//ng-dev/benchmark/component_benchmark:protractor-perf.conf.js",
        on_prepare = "//ng-dev/benchmark/component_benchmark:start-server.js",
        server = server,
