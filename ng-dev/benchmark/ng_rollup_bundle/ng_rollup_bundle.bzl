...
load("//ng-dev/bazel:expand_template.bzl", "expand_template")
...
def ng_rollup_bundle(
    ...
    expand_template(
        ...
        template = "//ng-dev/benchmark/ng_rollup_bundle:rollup.config-tmpl.js",
    ...
    common_terser_options = {
        "visibility": visibility,
        "config_file": "//ng-dev/benchmark/ng_rollup_bundle:terser_config.json",
    ...
    npm_package_bin(
        ...
        tool = "//ng-dev/benchmark/brotli-cli",
        data = [name + ".min.js"],
        outs = [name + ".min.js.br"],
        args = [
