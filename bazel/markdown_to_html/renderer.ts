...
import {handleCode} from './tranformations/code.js';
import {handleEmoji} from './tranformations/emoji.js';
import {transformH1} from './tranformations/h1.js';
import {transformHeader} from './tranformations/header.js';
import {transformImage} from './tranformations/image.js';
import {transformLink} from './tranformations/link.js';
import {transformDocsList} from './tranformations/lists.js';
import {transformDocsTable} from './tranformations/table.js';

/**
 * Custom renderer for marked that will be used to transform markdown files to HTML
 * files that can be used in the Angular docs.
 */
export const renderer: Partial<marked.Renderer> = {
